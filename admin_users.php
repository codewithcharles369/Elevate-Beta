...
<body class="<?php echo htmlspecialchars($theme); ?>">
        ...
        <ul>
                ...
                <li><a href="admin_users.php" class="active"><i class="fas fa-user-cog"></i>Manage Users</a></li>
        ...
        <ul class="nav">
              ...
              <a href="#"><li class="animate-on-scroll icon"><a href="admin_users.php"><i class="fas fa-user-cog"></i></a></li>
    ...
    <h2 class="animate-on-scroll">Manage Users</h2>
    ...
    <table id="myTable" class="user-table">
      ...
      <?php foreach ($users as $user): ?>
        ...
        <td class="animate-on-scroll"><img src="<?php echo $user['profile_picture'] ?: 'default-avatar.png'; ?>" alt="John's Profile Picture" class="profile-img"></td>
          <td class="animate-on-scroll"><?php echo htmlspecialchars($user['name']); ?></td>
          <td class="animate-on-scroll center-text"><?php echo htmlspecialchars($user['level']); ?></td>
          <td class="animate-on-scroll"><?php echo htmlspecialchars($user['role']); ?></td>
          <td class="animate-on-scroll center-text">
            <?php if ($user['role'] === 'User'): ?>
                <a class="btn " href="user_profile.php?id=<?php echo $user['id']; ?>"><i class="fas fa-eye"></i></a>
            <?php endif; ?>
            <?php if ($user['role'] === 'User'): ?>
                <a class="btn delete-btn" href="delete_user.php?id=<?php echo $user['id']; ?>" onclick="return confirm('Delete this user?');"><i class="fas fa-trash"></i></a>
            <?php endif; ?>
            <?php if ($user['role'] === 'User'): ?>
                <a class="btn" href="promote_user.php?id=<?= $user['id']; ?>"><i class="fas fa-caret-up"></i></a>
            <?php elseif ($user['role'] === 'Admin'): ?>
                <a class="btn delete-btn" href="demote_user.php?id=<?= $user['id']; ?>"><i class="fas fa-caret-down"></i></a>
            <?php endif; ?>
        </td>
        </tr>
        <?php endforeach; ?>
