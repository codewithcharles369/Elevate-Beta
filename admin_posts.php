...
$stmt = $pdo->query("SELECT posts.id, posts.title, users.name AS author, posts.created_at 
                     FROM posts 
...
<body class="<?php echo htmlspecialchars($theme); ?>">
    ...
    <aside class="sidebar" style="overflow-y: scroll;">
        ...
        <ul>
                ...
                <li><a href="admin_posts.php" class="active"><i class="fas fa-file-alt"></i>Manage Posts</a></li>
        ...
        <ul class="nav">
              ...
              <a href=""><li  class="animate-on-scroll icon"><a href="admin_posts.php"><i class="fas fa-file-alt"></i></a></li>
        ...
        <table id="myTable" class="admin-table">
            ...
            <tbody>
                <?php foreach ($posts as $post): ?>
                    <tr class="animate-on-scroll">
                        <td class="animate-on-scroll"><?php echo htmlspecialchars(substr($post['title'], 0, 15)); ?>...</td>
                        <td class="animate-on-scroll"><?php echo htmlspecialchars($post['author']); ?></td>
                        <td class="animate-on-scroll"><?php echo htmlspecialchars(substr($post['created_at'], 0, 10)); ?>...</td>
                        <td style="display: flex" class="animate-on-scroll center-text">
                            <a class="btn" href="view_post2.php?id=<?php echo $post['id']; ?>"><i class="fas fa-eye"></i></a>
                            <a class="btn delete-btn" href="admin_delete_post.php?id=<?php echo $post['id']; ?>" onclick="return confirm('Delete this post?');"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
